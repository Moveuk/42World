                                ...
                                <div id="tab1">
                                    ...
                                    <div class="tabHomeStoryRoom">
                                        ...
                                        <div class="miniroomImg">
                                            ...
                                            <div class="minimi">
                                                <img src="../resources/img/minimi.png" alt="minimiImg" name="minimiImg"
                                                    id="minimiImg">
                                            </div>
                                        </div>
                        ...
                        <div class="left">
                            ...
                            <div class="leftHome">
                                ...
                                <ul class="profileFolders">
                                    ...
                                    <li><img src="../resources/img/user.png"><a href="#profileFolder1">내 소개</a></li>
                                </ul>
                                <ul class="profileFolders">

                                    <li><img src="../resources/img/audience.png"><a href="#profileFolder2">내 인맥</a></li>
                                </ul>
                                <ul class="profileFolders">

                                    <li><img src="../resources/img/star.png"><a href="#profileFolder3">내 즐겨찾기</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="left">
                            ...
                            <div class="leftHome">
                                ...
                                <ul class="photoFolders">
                                    ...
                                    <li><img src="../resources/img/open.png"><a href="#photoFolder1">기본 사진첩</a></li>
                                </ul>
                                <ul class="photoFolders">

                                    <li><img src="../resources/img/close.png"><a href="#photoFolder2">자유 사진첩</a></li>
                                </ul>
                                <ul class="photoFolders">

                                    <li><img src="../resources/img/close.png"><a href="#photoFolder3">풍경 사진첩</a></li>
                                </ul>
                        ...
                        <div class="left">
                            ...
                            <div class="leftHome">
                                ...
                                <ul class="videoFolders">
                                    ...
                                    <li><img src="../resources/img/open.png"><a href="#videoFolder1">기본 비디오 폴더</a></li>
                                </ul>
                                <ul class="videoFolders">

                                    <li><img src="../resources/img/close.png"><a href="#videoFolder2">자유 비디오 폴더</a></li>
                                </ul>
                                <ul class="videoFolders">

                                    <li><img src="../resources/img/close.png"><a href="#videoFolder3">풍경 비디오 폴더</a></li>
                                </ul>
                        ...
                        <div class="left">
                            ...
                            <div class="leftHome">
                                ...
                                <ul class="boardFolders">
                                    ...
                                    <li><img src="../resources/img/open.png"><a href="#boardFolder1"><span>기본게시판폴더</span></a></li>
                                </ul>
                                <ul class="boardFolders">

                                    <li><img src="../resources/img/close.png"><a href="#boardFolder2"><span>커피</span></a></li>
                                </ul>
                                <ul class="boardFolders">

                                    <li><img src="../resources/img/close.png"><a href="#boardFolder3"><span>시계</span></a></li>
                                </ul>
                        ...
                        <table class="visitor_top2_table">
                            <tr>
                                <td class="visitor_top2_table_left">
                                    ...
                                    <a href="#">name<img src="../resources/img/house.png"></a>&nbsp;&nbsp; 
                                    <p>(date)</p></td>
