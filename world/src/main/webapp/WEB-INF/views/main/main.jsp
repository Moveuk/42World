		...
		$
				.ajax({
					...
					success : function(resp) {//결과값
						...
						window
								.open(resp, "일촌신청",
										"width=500, height=600, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
			...
			<div class="main1_main_profile">
				<div class="main1_main_profile_div">
					...
					<div class="main1_main_profile_div_footer">
						<input type="button"
							onclick="window.open('${member.memberNo}','memberNo minihome','width=1400,height=800,location=no,status=no,scrollbars=yes')"
							value="내 미니홈피가기">
					</div>
=======
            </div>
