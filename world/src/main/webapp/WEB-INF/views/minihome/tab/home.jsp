...
<div class="left">
	<div class="leftContent">
		<img src="${pageContext.request.contextPath}/resources/img/minimi/${ownerInfo.propic }" name="mainImg" id="mainImg"
			alt="mainImg">
		<textarea name="self" id="self" rows="5" cols="23" readonly>${ownerInfo.subtitle }</textarea>
		<input type="button" name="leftEdit" id="leftEdit" value="EDIT" onclick="edit()">
		<hr style="width: 90%">
		<input type="text" name="name" id="name" value="${ownerInfo.name }" size="2" readonly>
		<!-- <input type="text" name="gender" id="gender" value="여" size="1" readonly> -->
		<c:choose>
			<c:when test="${ownerInfo.gender==1 }">
		...
		<input type="text" name="birth" id="birth" value="${ownerInfo.birth }" size="6" readonly>
