<<<<<<< Updated upstream:world/src/main/webapp/WEB-INF/views/minihome/tab/home.jsp
								...
								<div id="tab1">
									...
									<div class="tabHomeNew">
										<div class="left">
											<ul class="leftul">
												<li>
													<input type="button" name="newlyButtonPhoto"
														id="newlyButtonPhoto" value="사진첩">
													<a href="#">최근게시물1</a>
												</li>
												<li>
													<input type="button" name="newlyButtonVideo"
														id="newlyButtonVideo" value="비디오">
													<a href="#">최근게시물2</a>
												</li>
												<li>
													<input type="button" name="newlyButtonboard"
														id="newlyButtonboard" value="게시판">
													<a href="#">최근게시물3</a>
												</li>
												<li>
													<input type="button" name="newlyButtonPhoto"
										...
										<div class="right">
											<ul>
												<li>
													<input type="button" name="rightNewlyButton"
														id="rightNewlyButton" value="new">
													&nbsp;&nbsp;게시판
												</li>
												<li>1/5</li>
											</ul>
									...
									<div class="tabHomeStoryRoom">
										...
										<div class="miniroomImg">
											<div class="miniroom">
												<img src="/resources/img/miniroom.png"
													alt="miniroomBackImg" id="miniroomBackImg"
...
<div class="rightHome">
	...
	<div class="tabHomeNew">
		<div class="recentArticle">
			<ul class="leftul">
				<li><input type="button" name="newlyButtonPhoto" id="newlyButtonPhoto" value="사진첩"></li>
				<li><span>최근게시물1</span></li>
			</ul>
			<ul class="leftul">
				<li><input type="button" name="newlyButtonVideo" id="newlyButtonVideo" value="비디오"></li>
				<li><a href="#">최근게시물2</a></li>
			</ul>
			<ul class="leftul">
				<li><input type="button" name="newlyButtonboard" id="newlyButtonboard" value="게시판"></li>
		...
		<div class="updateCategory">
			<ul>
				<li><input type="button" name="rightNewlyButton"
					id="rightNewlyButton" value="new"> </li>
				<li><span>게시판&nbsp;&nbsp;</span>1/5</li>
			</ul>
			<ul>
				<li><input type="button" name="rightNewlyButton"
					id="rightNewlyButton" value="new"></li>
				<li><span>방명록&nbsp;&nbsp;</span>1/5</li>
			</ul>
			<ul>
				<li></li>
				<li><span>사진첩&nbsp;&nbsp;</span>1/5</li>
			</ul>
			<ul>
				<li><input type="button" name="rightNewlyButton"
					id="rightNewlyButton" value="new"></li>
				<li><span>동영상&nbsp;</span>1/5</li>
			</ul>
		</div>
	</div>
	<div class="tabHomeStoryRoom">
		...
		<div class="miniroomImg">
			<div class="miniroom">
				<img src="../resources/img/miniroom.png" alt="miniroomBackImg"
	...
	<div class="comment">
		<div class="commentHeader">
			...
			<div class="commentForm">
				<span>Friend Say</span> 
				<input type="text" name="commentInput"
					placeholder="친구에게 일촌평을 작성해주세요" id="commentInput" name="commentInput">
...
>>>>>>> Stashed changes:world/src/main/webapp/minihome/right/rightHome.jsp
